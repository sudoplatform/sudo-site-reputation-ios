...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SudoApiClient/SudoApiClient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoConfigManager/SudoConfigManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoKeyManager/SudoKeyManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoLogging/SudoLogging.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoUser/SudoUser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoEntitlements/SudoEntitlements.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoEntitlementsAdmin/SudoEntitlementsAdmin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SudoProfiles/SudoProfiles.framework"
fi
